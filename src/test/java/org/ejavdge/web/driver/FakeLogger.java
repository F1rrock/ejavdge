...
public final class FakeLogger implements Logger {
    public boolean isTraceEnabledCalled = false;
    public int traceCalls = 0;
    ...
    @Override public void debug(String msg) { forbidden("debug"); }
    ...
    @Override public boolean isDebugEnabled() { forbidden("isDebugEnabled"); return false; }
